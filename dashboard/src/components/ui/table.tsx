...
>(({ className, ...props }, ref) => (
    <div className="relative w-full overflow-auto rounded-md border border-white/[0.08] bg-black">
        <table
            ref={ref}
...
>(({ className, ...props }, ref) => (
    <thead ref={ref} className={cn("[&_tr]:border-b [&_tr]:border-white/[0.08] bg-white/[0.015]", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
    <tr
        ref={ref}
        className={cn(
            "border-b border-white/[0.06] transition-colors duration-150 hover:bg-white/[0.03] data-[state=selected]:bg-white/[0.05]",
            className
        )}
        {...props}
    />
